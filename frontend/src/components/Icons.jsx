...
export function ConnectIcon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M14.5 6.5H8.81314C7.00339 6.5 6.38405 8.91123 7.96978 9.78338L16.0302 14.2166C17.616 15.0888 16.9966 17.5 15.1869 17.5H9.5" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14.75 7.25V5.75C14.75 4.64543 15.6454 3.75 16.75 3.75H18.25C19.3546 3.75 20.25 4.64543 20.25 5.75V7.25C20.25 8.35457 19.3546 9.25 18.25 9.25H16.75C15.6454 9.25 14.75 8.35457 14.75 7.25Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3.75 18.25V16.75C3.75 15.6454 4.64543 14.75 5.75 14.75H7.25C8.35457 14.75 9.25 15.6454 9.25 16.75V18.25C9.25 19.3546 8.35457 20.25 7.25 20.25H5.75C4.64543 20.25 3.75 19.3546 3.75 18.25Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function PlusIcon(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 32 32" {...props}>
      {/* Use currentColor so it inherits the button text color */}
      <path
        fill="currentColor"
        d="M4 24a4 4 0 1 1 0 8a4 4 0 0 1 0-8m24 0a4 4 0 1 1 0 8a4 4 0 0 1 0-8M4 26a2 2 0 1 0 0 4a2 2 0 0 0 0-4m24 0a2 2 0 1 0 0 4a2 2 0 0 0 0-4M17 9v6h6v2h-6v6h-2v-6H9v-2h6V9zM4 0a4 4 0 1 1 0 8a4 4 0 0 1 0-8m24 0a4 4 0 1 1 0 8a4 4 0 0 1 0-8m0 2a2 2 0 1 0 0 4a2 2 0 0 0 0-4M4 2a2 2 0 1 0 0 4a2 2 0 0 0 0-4"
      />
      <path
        fill="currentColor"
